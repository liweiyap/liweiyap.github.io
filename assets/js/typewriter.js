...
typewriter
    ...
    .typeString('<br/>')
    .typeString(styleString('liweiyap ............ | 38', ''))
    .typeString('<br/>')
    ...
    .typeString('<br/>')
    .typeString(styleString('Total commits: 921', ''))

...
typewriter
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">liweiyap ............ | 25</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">PvZ ................. | 22</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">xkcdbrowser-android . | 21</span>')
    .typeString('<br/>')
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">Total commits: 706</span>')

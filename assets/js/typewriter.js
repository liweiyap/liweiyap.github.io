...
typewriter
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">LeetCode_Solutions .. | 104</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">liweiyap.github.io .. | 69</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">Conway_GameOfLife ... | 57</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">narradir-android .... | 50</span>')
    .typeString('<br/>')
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">liweiyap ............ | 24</span>')
    .typeString('<br/>')
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">Total commits: 670</span>')

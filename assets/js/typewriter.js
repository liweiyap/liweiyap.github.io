...
typewriter
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">liweiyap.github.io .. | 68</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">Conway_GameOfLife ... | 57</span>')
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">narradir-android .... | 46</span>')
    .typeString('<br/>')
    ...
    .typeString('<br/>')
    .typeString('<span style="color:greenyellow;font-family:Inconsolata;font-size:90%;">Total commits: 658</span>')
